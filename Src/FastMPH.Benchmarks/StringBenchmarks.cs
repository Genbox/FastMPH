...
public class StringBenchmarks
{
    ...
    public IEnumerable<object[]> GetConstructImpl()
    {
        ...
        Validator.RequireThat(new ChdBuilder<string>(NullLogger<ChdBuilder<string>>.Instance).TryCreateMinimalWithRetry(_data, _stringHash, out ChdMinimalState<string>? chdmPre));
        yield return ["CHD_M", BitsPerItem(chdmPre.GetPackedSize()), new CFunc(data => new ChdBuilder<string>(NullLogger<ChdBuilder<string>>.Instance).TryCreateMinimalWithRetry(data, _stringHash, out _, new ChdMinimalSettings()))];

        Validator.RequireThat(new ChdBuilder<string>(NullLogger<ChdBuilder<string>>.Instance).TryCreateWithRetry(_data, _stringHash, out ChdState<string>? chdPre));
        yield return ["CHD", BitsPerItem(chdPre.GetPackedSize()), new CFunc(data => new ChdBuilder<string>(NullLogger<ChdBuilder<string>>.Instance).TryCreateWithRetry(data, _stringHash, out _, new ChdSettings()))];

        Validator.RequireThat(new BdzBuilder<string>(NullLogger<BdzBuilder<string>>.Instance).TryCreateWithRetry(_data, _stringHash, out BdzState<string>? bdzPre));
        yield return ["BDZ", BitsPerItem(bdzPre.GetPackedSize()), new CFunc(data => new BdzBuilder<string>(NullLogger<BdzBuilder<string>>.Instance).TryCreateWithRetry(data, _stringHash, out _, new BdzSettings()))];

        Validator.RequireThat(new BdzBuilder<string>(NullLogger<BdzBuilder<string>>.Instance).TryCreateMinimalWithRetry(_data, _stringHash, out BdzMinimalState<string>? bdzmPre));
        yield return ["BDZ_M", BitsPerItem(bdzmPre.GetPackedSize()), new CFunc(data => new BdzBuilder<string>(NullLogger<BdzBuilder<string>>.Instance).TryCreateMinimalWithRetry(data, _stringHash, out _, new BdzMinimalSettings()))];

        Validator.RequireThat(new BmzBuilder<string>(NullLogger<BmzBuilder<string>>.Instance).TryCreateMinimalWithRetry(_data, _stringHash, out BmzMinimalState<string>? bmzPre));
        yield return ["BMZ_M", BitsPerItem(bmzPre.GetPackedSize()), new CFunc(data => new BmzBuilder<string>(NullLogger<BmzBuilder<string>>.Instance).TryCreateMinimalWithRetry(data, _stringHash, out _, new BmzMinimalSettings()))];

        Validator.RequireThat(new ChmBuilder<string>(NullLogger<ChmBuilder<string>>.Instance).TryCreateMinimalWithRetry(_data, _stringHash, out ChmMinimalState<string>? chmPre));
        yield return ["CHM_M", BitsPerItem(chmPre.GetPackedSize()), new CFunc(data => new ChmBuilder<string>(NullLogger<ChmBuilder<string>>.Instance).TryCreateMinimalWithRetry(data, _stringHash, out _, new ChmMinimalSettings()))];

        Validator.RequireThat(new FchBuilder<string>(NullLogger<FchBuilder<string>>.Instance).TryCreateMinimalWithRetry(_data, _stringHash, out FchMinimalState<string>? fchPre));
        yield return ["FCH_M", BitsPerItem(fchPre.GetPackedSize()), new CFunc(data => new FchBuilder<string>(NullLogger<FchBuilder<string>>.Instance).TryCreateMinimalWithRetry(data, _stringHash, out _, new FchMinimalSettings()))];
    ...
    public IEnumerable<object[]> GetQueryImpl()
    {
        ...
        Validator.RequireThat(new ChdBuilder<string>(NullLogger<ChdBuilder<string>>.Instance).TryCreateMinimalWithRetry(_data, _stringHash, out ChdMinimalState<string>? state6));
        yield return ["CHD_M", BitsPerItem(state6.GetPackedSize()), new QFunc(data => state6.Search(data))];

        Validator.RequireThat(new ChdBuilder<string>(NullLogger<ChdBuilder<string>>.Instance).TryCreateWithRetry(_data, _stringHash, out ChdState<string>? state7));
        yield return ["CHD", BitsPerItem(state7.GetPackedSize()), new QFunc(data => state7.Search(data))];

        Validator.RequireThat(new BdzBuilder<string>(NullLogger<BdzBuilder<string>>.Instance).TryCreateWithRetry(_data, _stringHash, out BdzState<string>? state1));
        yield return ["BDZ", BitsPerItem(state1.GetPackedSize()), new QFunc(data => state1.Search(data))];

        Validator.RequireThat(new BdzBuilder<string>(NullLogger<BdzBuilder<string>>.Instance).TryCreateMinimalWithRetry(_data, _stringHash, out BdzMinimalState<string>? state2));
        yield return ["BDZ_M", BitsPerItem(state2.GetPackedSize()), new QFunc(data => state2.Search(data))];

        Validator.RequireThat(new BmzBuilder<string>(NullLogger<BmzBuilder<string>>.Instance).TryCreateMinimalWithRetry(_data, _stringHash, out BmzMinimalState<string>? state3));
        yield return ["BMZ_M", BitsPerItem(state3.GetPackedSize()), new QFunc(data => state3.Search(data))];

        Validator.RequireThat(new ChmBuilder<string>(NullLogger<ChmBuilder<string>>.Instance).TryCreateMinimalWithRetry(_data, _stringHash, out ChmMinimalState<string>? state4));
        yield return ["CHM_M", BitsPerItem(state4.GetPackedSize()), new QFunc(data => state4.Search(data))];

        Validator.RequireThat(new FchBuilder<string>(NullLogger<FchBuilder<string>>.Instance).TryCreateMinimalWithRetry(_data, _stringHash, out FchMinimalState<string>? state5));
        yield return ["FCH_M", BitsPerItem(state5.GetPackedSize()), new QFunc(data => state5.Search(data))];

        Validator.RequireThat(new BbHashBuilder<string>(NullLogger<BbHashBuilder<string>>.Instance).TryCreateMinimalWithRetry(_data, _stringHash, out BbHashMinimalState<string>? bbState));
        yield return ["BB_M", BitsPerItem(bbState.GetPackedSize()), new QFunc(data => bbState.Search(data))];

        Validator.RequireThat(new PtrHashBuilder<string>(NullLogger<PtrHashBuilder<string>>.Instance).TryCreateMinimalWithRetry(_data, _stringHash, out PtrHashMinimalState<string>? ptrState));
        yield return ["PTR_M", BitsPerItem(ptrState.GetPackedSize()), new QFunc(data => ptrState.Search(data))];

        Validator.RequireThat(new HybleBuilder<string>(NullLogger<HybleBuilder<string>>.Instance).TryCreateWithRetry(_data, _stringHash, out HybleState<string>? hybleState));
