...
public class IntBenchmarks
{
    ...
    public IEnumerable<object[]> GetConstructImpl()
    {
        ...
        Validator.RequireThat(new ChdBuilder<int>(NullLogger<ChdBuilder<int>>.Instance).TryCreateMinimal(_data, out ChdMinimalState<int>? chdmPre));
        yield return ["CHD_M", BitsPerItem(chdmPre.GetPackedSize()), new CFunc(data => new ChdBuilder<int>(NullLogger<ChdBuilder<int>>.Instance).TryCreateMinimal(data, out _, new ChdMinimalSettings()))];

        Validator.RequireThat(new ChdBuilder<int>(NullLogger<ChdBuilder<int>>.Instance).TryCreate(_data, out ChdState<int>? chdPre));
        yield return ["CHD", BitsPerItem(chdPre.GetPackedSize()), new CFunc(data => new ChdBuilder<int>(NullLogger<ChdBuilder<int>>.Instance).TryCreate(data, out _, new ChdSettings()))];

        Validator.RequireThat(new BdzBuilder<int>(NullLogger<BdzBuilder<int>>.Instance).TryCreate(_data, out BdzState<int>? bdzPre));
        yield return ["BDZ", BitsPerItem(bdzPre.GetPackedSize()), new CFunc(data => new BdzBuilder<int>(NullLogger<BdzBuilder<int>>.Instance).TryCreate(data, out _, new BdzSettings()))];

        Validator.RequireThat(new BdzBuilder<int>(NullLogger<BdzBuilder<int>>.Instance).TryCreateMinimal(_data, out BdzMinimalState<int>? bdzmPre));
        yield return ["BDZ_M", BitsPerItem(bdzmPre.GetPackedSize()), new CFunc(data => new BdzBuilder<int>(NullLogger<BdzBuilder<int>>.Instance).TryCreateMinimal(data, out _, new BdzMinimalSettings()))];

        Validator.RequireThat(new BmzBuilder<int>(NullLogger<BmzBuilder<int>>.Instance).TryCreateMinimal(_data, out BmzMinimalState<int>? bmzPre));
        yield return ["BMZ_M", BitsPerItem(bmzPre.GetPackedSize()), new CFunc(data => new BmzBuilder<int>(NullLogger<BmzBuilder<int>>.Instance).TryCreateMinimal(data, out _, new BmzMinimalSettings()))];

        Validator.RequireThat(new ChmBuilder<int>(NullLogger<ChmBuilder<int>>.Instance).TryCreateMinimal(_data, out ChmMinimalState<int>? chmPre));
        yield return ["CHM_M", BitsPerItem(chmPre.GetPackedSize()), new CFunc(data => new ChmBuilder<int>(NullLogger<ChmBuilder<int>>.Instance).TryCreateMinimal(data, out _, new ChmMinimalSettings()))];

        Validator.RequireThat(new FchBuilder<int>(NullLogger<FchBuilder<int>>.Instance).TryCreateMinimal(_data, out FchMinimalState<int>? fchPre));
        yield return ["FCH_M", BitsPerItem(fchPre.GetPackedSize()), new CFunc(data => new FchBuilder<int>(NullLogger<FchBuilder<int>>.Instance).TryCreateMinimal(data, out _, new FchMinimalSettings()))];
    ...
    public IEnumerable<object[]> GetQueryImpl()
    {
        ...
        Validator.RequireThat(new ChdBuilder<int>(NullLogger<ChdBuilder<int>>.Instance).TryCreateMinimal(_data, out ChdMinimalState<int>? chdmState));
        yield return ["CHD_M", BitsPerItem(chdmState.GetPackedSize()), new QFunc(data => chdmState.Search(data))];

        Validator.RequireThat(new ChdBuilder<int>(NullLogger<ChdBuilder<int>>.Instance).TryCreate(_data, out ChdState<int>? chdState));
        yield return ["CHD", BitsPerItem(chdState.GetPackedSize()), new QFunc(data => chdState.Search(data))];

        Validator.RequireThat(new BdzBuilder<int>(NullLogger<BdzBuilder<int>>.Instance).TryCreate(_data, out BdzState<int>? bdzState));
        yield return ["BDZ", BitsPerItem(bdzState.GetPackedSize()), new QFunc(data => bdzState.Search(data))];

        Validator.RequireThat(new BdzBuilder<int>(NullLogger<BdzBuilder<int>>.Instance).TryCreateMinimal(_data, out BdzMinimalState<int>? bdzmState));
        yield return ["BDZ_M", BitsPerItem(bdzmState.GetPackedSize()), new QFunc(data => bdzmState.Search(data))];

        Validator.RequireThat(new BmzBuilder<int>(NullLogger<BmzBuilder<int>>.Instance).TryCreateMinimal(_data, out BmzMinimalState<int>? bmzState));
        yield return ["BMZ_M", BitsPerItem(bmzState.GetPackedSize()), new QFunc(data => bmzState.Search(data))];

        Validator.RequireThat(new ChmBuilder<int>(NullLogger<ChmBuilder<int>>.Instance).TryCreateMinimal(_data, out ChmMinimalState<int>? chmState));
